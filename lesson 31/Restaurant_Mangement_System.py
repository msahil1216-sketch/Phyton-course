# Import tkinter from GUI and ttk from improved widgets
...
class RestaurantOrderManagement:
    ...
    def __init__(self, root):
        ...
        # A dictionary too store the menu items and their prices
        self.menu_items = {
            "FRIES MEAL": 2,
            "LUNCH MEAL": 2,
            "BURGER MEAL": 2,
        ...
        self.exchange_rate = 82 # Excahnge rate for currency conversion
        ...
        self.menu_labels = {}     # To store reference to menu item labels
        self.menu_quantities = {} # to store reference to quantity entry widgets
    ...
    def setup_background(self, root):
        ...
        original_image = tk.PhotoImage(file = "C:\\Users\\Dell\\OneDrive\\Desktop\\phython course\\lesson 31\\background.jpg")
    ...
    def update_menu_prices(self, *args):
        ...
        for item, entry in self.menu_quantities.items():
            ...
            if quantity.isdigit():
                ...
                if quantity > 0:
                    order_summary += (
                        f"(items): {quantity} x {symbol}{price} =  {symbol}{cost}\n"
                    )
